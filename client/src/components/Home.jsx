...
export default function Home() {
    ...
    useEffect(() => {
        ...
        // Fetch public freelancers list
        myAxios.get('/user/freelancers')
            .then(res => {
        ...
        <div className='Home'>
                ...
                <section>
                    ...
                    {freelancers.length > 0 && (
                        <div className="home-freelancers" id='freelancers'>
                            <div className="custom-headline">Meet Our Freelancers</div>
                            <div className="home-freelancers-grid">
                                {freelancers.map(f => (
                                    <div key={f._id} className="home-freelancer-card">
                                        <img
                                            src={f.image === 'no-image.png' ? noImage : `${API_URL}/ProfilePic/${f.image}`}
                                            alt={f.username}
                                            className="home-freelancer-avatar"
                                        />
                                        <div className="home-freelancer-name">{f.fullName || f.username}</div>
                                        <div className="home-freelancer-username">@{f.username}</div>
                                        <div className="home-freelancer-stats">
                                            <span>{f.totalServices} {f.totalServices === 1 ? 'service' : 'services'}</span>
                                            {f.overallRating > 0 && (
                                                <span>
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="home-star-icon">
                                        ...
                                        <Link to={`/freelancer/${f.username}`}>
                                            <button className="home-freelancer-btn">View Profile</button>
                                        </Link>
                                    </div>
                                ))}
                            </div>
            ...
            <footer>
                ...
                <p className="footer-body">
                    Servezy is a leading provider of freelance services, connecting talented individuals with clients who need their skills and expertise. From website design and development to writing and marketing, our team has the knowledge and experience to help you succeed.
                </p>
                <div className="footer-footer">
                    <div className="copyright">
                        Servezy ©2025 | All Rights Reserved
                    </div>
